...
#ifndef MIGCOIN_TEST_SCRIPTNUM10_H
#define MIGCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Migcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // MIGCOIN_TEST_SCRIPTNUM10_H
