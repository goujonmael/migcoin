...
#ifndef MIGCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define MIGCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Migcoin Core wallet was originally a collection of unrelated private
...
#endif // MIGCOIN_WALLET_SCRIPTPUBKEYMAN_H
