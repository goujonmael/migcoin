...
#ifndef MIGCOIN_COMPAT_ASSUMPTIONS_H
#define MIGCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Migcoin cannot be compiled without assertions."
#endif
...
#endif // MIGCOIN_COMPAT_ASSUMPTIONS_H
