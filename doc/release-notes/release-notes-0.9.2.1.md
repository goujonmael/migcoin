Migcoin Core version 0.9.2.1 is now available from:

  https://migcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 MIG to 0.01 MIG
...
- Fix "Start migcoin on system login"
