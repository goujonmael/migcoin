...
class TxnMallTest(MigcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 MIG:
        ...
        # First: use raw transaction API to send 1240 MIG to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 MIG coin each
        ...
        # Node0's balance should be starting balance, plus 50MIG for another
        ...
        # Node0's total balance should be starting balance, plus 100MIG for
