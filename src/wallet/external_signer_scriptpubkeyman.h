...
#ifndef MIGCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define MIGCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // MIGCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
