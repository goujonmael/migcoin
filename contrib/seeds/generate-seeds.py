...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef MIGCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define MIGCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the migcoin network\n')
    ...
    g.write('#endif // MIGCOIN_CHAINPARAMSSEEDS_H\n')
