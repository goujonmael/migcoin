...
complete --command migcoind --no-files

# Extract options
function __fish_migcoind_get_options
...
complete \
    --command migcoind \
    --arguments "(__fish_migcoind_get_options --nofiles)"
