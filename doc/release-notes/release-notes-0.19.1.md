...
Migcoin Core version 0.19.1 is now available from:

  <https://migcoincore.org/bin/migcoin-core-0.19.1/>
...
From Migcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Migcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Migcoin Core does not yet change appearance when
...
- #17488 fix "migcoind already running" warnings on macOS (fanquake)
