...
export CONTAINER_NAME=ci_native_nowallet_libmigcoinkernel
...
export GOAL="install"
export MIGCOIN_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
