...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.migcoin.jonasschnelli.ch.");
        vSeeds.emplace_back("seed.tbtc.petertodd.org.");
        vSeeds.emplace_back("seed.testnet.migcoin.sprovoost.nl.");
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("seed.signet.migcoin.sprovoost.nl.");
