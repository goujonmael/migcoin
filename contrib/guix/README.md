...
This directory contains the files necessary to perform bootstrappable Migcoin
Core builds.
...
To build Migcoin Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Migcoin Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/migcoin-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/migcoin-core/guix.sigs).
