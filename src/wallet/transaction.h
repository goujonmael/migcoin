...
#ifndef MIGCOIN_WALLET_TRANSACTION_H
#define MIGCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this migcoin node, and set to 0 for transactions that were created
...
#endif // MIGCOIN_WALLET_TRANSACTION_H
