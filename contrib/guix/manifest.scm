...
(define* (make-migcoin-cross-toolchain target
                                       #:key
...
desirable for building Migcoin Core release binaries."
...
;; failure; see https://github.com/migcoin/migcoin/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-migcoin-cross-toolchain target)))
