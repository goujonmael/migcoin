...
#ifndef MIGCOIN_WALLET_WALLETUTIL_H
#define MIGCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! migcoin from opening the wallet, thinking it was newly created, and
...
#endif // MIGCOIN_WALLET_WALLETUTIL_H
