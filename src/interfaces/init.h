...
#ifndef MIGCOIN_INTERFACES_INIT_H
#define MIGCOIN_INTERFACES_INIT_H
...
//! (migcoin-gui, migcoin-node, migcoin-wallet, migcoind, migcoin-qt) and each
...
#endif // MIGCOIN_INTERFACES_INIT_H
