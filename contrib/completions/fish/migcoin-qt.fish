...
complete --command migcoin-qt --no-files

# Extract options
function __fish_migcoinqt_get_options
...
complete \
    --command migcoin-qt \
    --arguments "(__fish_migcoinqt_get_options --nofiles)"
