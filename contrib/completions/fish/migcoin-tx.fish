...
# Extract options
function __fish_migcoin_tx_get_options
...
# Extract commands
function __fish_migcoin_tx_get_commands
...
complete \
    --command migcoin-tx \
    --condition "not __fish_migcoin_seen_cmd (__fish_migcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_migcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command migcoin-tx \
    --arguments "(__fish_migcoin_tx_get_commands)" \
    --no-files
