Migcoin Core version 0.10.4 is now available from:

  <https://migcoin.org/bin/migcoin-core-0.10.4/>
...
- #6953 `43c2789` Split migcoin-tx into its own package
- #6953 `dfe0d4d` Include migcoin-tx binary on Debian/Ubuntu
