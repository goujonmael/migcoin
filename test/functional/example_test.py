...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MigcoinTestFramework
    pass


class ExampleTest(MigcoinTestFramework):
    # Each functional test is a subclass of the MigcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        MigcoinTestFramework class so other tests can use it."""
