...
#ifndef MIGCOIN_QT_GUIUTIL_H
#define MIGCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Migcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "migcoin:" URI into recipient object, return true on successful parsing
