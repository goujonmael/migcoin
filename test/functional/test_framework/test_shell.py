...
class TestShell:
    """Wrapper Class for MigcoinTestFramework.

    The TestShell class extends the MigcoinTestFramework
    ...
    class __TestShell(MigcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by MigcoinTestFramework child class.
            self.num_nodes = 1
