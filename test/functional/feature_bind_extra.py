...
"""
Test starting migcoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(MigcoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that migcoind has bound on "::1" (for RPC) and "::" (for P2P).
