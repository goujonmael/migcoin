...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/migcoin/migcoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(MigcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our migcoind node")
