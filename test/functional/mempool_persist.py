...
By default, migcoind will dump mempool on shutdown and
...
class MempoolPersistTest(MigcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent migcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
