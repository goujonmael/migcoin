Migcoin Core version *0.15.2* is now available from:

  <https://migcoincore.org/bin/migcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in migcoin-tx (TheBlueMatt)
