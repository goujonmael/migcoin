Migcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/migcoin/files/Migcoin/migcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Migcoin
...
New/changed settings (command-line or migcoin.conf file)
--------------------------------------------------------
