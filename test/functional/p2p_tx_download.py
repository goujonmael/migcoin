#!/usr/bin/env python3
# Copyright (c) 2019-2021 The Migcoin Core developers
...
class TxDownloadTest(MigcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new migcoind instances, as setting mocktimes has long-term effects on when
