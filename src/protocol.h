...
#ifndef MIGCOIN_PROTOCOL_H
#define MIGCOIN_PROTOCOL_H
...
/**
 * Migcoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Migcoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // migcoin-development mailing list. Remember that service bits are just
