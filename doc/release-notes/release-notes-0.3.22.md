Download URL: https://sourceforge.net/projects/migcoin/files/Migcoin/migcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 MIG fee schedule (users still pay 0.01 MIG per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #migcoin00 - #migcoin99
