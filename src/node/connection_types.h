...
#ifndef MIGCOIN_NODE_CONNECTION_TYPES_H
#define MIGCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/migcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Migcoin’s Peer-to-Peer Network")
...
#endif // MIGCOIN_NODE_CONNECTION_TYPES_H
