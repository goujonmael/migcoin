...
#ifndef MIGCOIN_KERNEL_CONTEXT_H
#define MIGCOIN_KERNEL_CONTEXT_H
...
//! passed to external libmigcoin_kernel functions which need access to this
...
#endif // MIGCOIN_KERNEL_CONTEXT_H
