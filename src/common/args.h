...
#ifndef MIGCOIN_COMMON_ARGS_H
#define MIGCOIN_COMMON_ARGS_H
...
extern const char * const MIGCOIN_CONF_FILENAME;
extern const char * const MIGCOIN_SETTINGS_FILENAME;
