...
"""  Tests the mempool:* tracepoint API interface.
     See https://github.com/migcoin/migcoin/blob/master/doc/tracing.md#context-mempool
"""
...
class MempoolTracepointTest(MigcoinTestFramework):
    ...
    def rejected_test(self):
        ...
        # https://github.com/migcoin/migcoin/issues/27380
