...
//! Entry point for MigcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &MigcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for MigcoinGUI tests.
void AppTests::guiTests(MigcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &MigcoinGUI::consoleShown, this, &AppTests::consoleTests);
