...
{
    BOOST_CHECK(TestSplitHost("www.migcoincore.org", "www.migcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.migcoincore.org]", "www.migcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.migcoincore.org:80", "www.migcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.migcoincore.org]:80", "www.migcoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.migcoincore.org:65536", "www.migcoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.migcoincore.org:0", "www.migcoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.migcoincore.org:", "www.migcoincore.org:", 0, false));
}
