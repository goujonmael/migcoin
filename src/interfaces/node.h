...
#ifndef MIGCOIN_INTERFACES_NODE_H
#define MIGCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a migcoin node (migcoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or migcoin.conf.
...
#endif // MIGCOIN_INTERFACES_NODE_H
