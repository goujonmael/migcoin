...
{
    // Test regression https://github.com/migcoin/migcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/migcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/migcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Migcoin/Migcoin-Qt.conf and all else left as default,
    // migcoin-qt should set both -listen and -listenonion to false and start successfully.
