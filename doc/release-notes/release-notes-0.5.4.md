Migcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/migcoin/files/Migcoin/migcoin-0.5.4/
...
http://gitorious.org/migcoin/migcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Migcoin-Qt notifications under Growl 1.3.
Increase required age of Migcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMigcoin properly when installing Migcoin-Qt over it. (Windows)
