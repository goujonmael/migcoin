...
Verify that a migcoind node can use an external signer command.
...
class RPCSignerTest(MigcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart migcoind with -signer=<cmd>',
