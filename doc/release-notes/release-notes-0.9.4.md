Migcoin Core version 0.9.4 is now available from:

  https://migcoin.org/bin/0.9.4/
...
this update is incompatible with the Migcoin system and could lead to consensus
forks.

Migcoin Core released binaries from https://migcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~migcoin/+archive/ubuntu/migcoin
- A third-party or self-compiled Migcoin Core

upgrade to Migcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
