Migcoin Core version 0.13.2 is now available from:

  <https://migcoin.org/bin/migcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update migcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow migcoin-tx to create v2 transactions (btcdrak)
