...
"""Example logging Migcoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/migcoind
...
def main(migcoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[migcoind_with_usdts])
