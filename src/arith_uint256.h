...
#ifndef MIGCOIN_ARITH_UINT256_H
#define MIGCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Migcoin only uses this "compact" format for encoding difficulty
