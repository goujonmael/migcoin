Migcoin Core version 0.16.1 is now available from:

  <https://migcoincore.org/bin/migcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting migcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure migcoind processes are cleaned up when tests end (sdaftuar)
