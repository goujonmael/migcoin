      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->migcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->migcoinAtStartup);
    ...
    ui->migcoinAtStartup->setToolTip(ui->migcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->migcoinAtStartup->setText(ui->migcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openMigcoinConfButton->setToolTip(ui->openMigcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new MigcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->migcoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSMIGontrols);
...
void OptionsDialog::on_openMigcoinConfButton_clicked()
{
